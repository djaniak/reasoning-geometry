...
| [`PAPER_STRATEGY_DAG.md`](PAPER_STRATEGY_DAG.md) | Residual-stream activation patching on a synthetic arithmetic DAG; DeepSeek-R1-Distill-Qwen-1.5B | **Workshop-submittable now.** Main-conference path runs through a clean-valid multi-step format (§6b, G1/G2); the node-influence matrix E4 is **gated behind it**, not next. |
