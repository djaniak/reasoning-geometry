...
from dag.dag_patching import GATE_POLICIES, rescore_report
from dag.dag_tasks import ANCESTOR, CHECKPOINTS, generate_items
...
def main() -> None:
    ...
    if args.tokenizer_report:
        from dag.dag_tasks import check_tokenizers
