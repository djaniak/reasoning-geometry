...
`probe_token_tail_q20` is the pooling-matched probe: LDA per tail token, token scores averaged, which is the order `rmd_tail_q20` uses. The last column is therefore the supervision effect with pooling held fixed; the one before it confounds the two.

| labelled prompts | `rmd_tail_q20` | `probe_hidden_tail_q20` | `probe_token_tail_q20` | rmd − probe | rmd − token probe |
|---:|---|---|---|---|---|
| 25 | 0.719 [0.639, 0.796] | 0.692 [0.646, 0.759] | 0.700 [0.605, 0.774] | 0.028 [-0.060, 0.070] | 0.021 [-0.080, 0.080] |
| 50 | 0.780 [0.656, 0.809] | 0.765 [0.680, 0.800] | 0.759 [0.714, 0.814] | 0.028 [-0.091, 0.085] | 0.016 [-0.098, 0.073] |
| 100 | 0.799 [0.743, 0.834] | 0.786 [0.748, 0.816] | 0.789 [0.761, 0.815] | 0.023 [-0.051, 0.043] | 0.017 [-0.040, 0.029] |
...
| labelled prompts | eval n | base acc | B0 | B0+rmd | B0+probe | B0+token probe | excess B0+rmd | excess B0+probe |
|---:|---:|---|---|---|---|---|---|---|
| 25 | 314 | 0.689 | 0.230 [0.207, 0.251] | 0.193 [0.158, 0.255] | 0.218 [0.183, 0.249] | 0.216 [0.167, 0.243] | -0.109 [-0.149, -0.062] | -0.082 [-0.129, -0.060] |
| 50 | 314 | 0.689 | 0.216 [0.191, 0.280] | 0.154 [0.140, 0.201] | 0.172 [0.156, 0.216] | 0.190 [0.141, 0.236] | -0.151 [-0.166, -0.110] | -0.135 [-0.154, -0.084] |
| 100 | 314 | 0.689 | 0.203 [0.189, 0.218] | 0.139 [0.116, 0.160] | 0.149 [0.129, 0.164] | 0.146 [0.127, 0.184] | -0.168 [-0.180, -0.145] | -0.162 [-0.176, -0.139] |
...
| labelled prompts | `rmd_tail_q20` | `probe_hidden_tail_q20` | `probe_token_tail_q20` | rmd − probe | rmd − token probe |
|---:|---|---|---|---|---|
| 25 | 0.663 [0.585, 0.789] | 0.664 [0.599, 0.733] | 0.625 [0.546, 0.720] | 0.003 [-0.037, 0.061] | 0.034 [0.020, 0.075] |
| 50 | 0.732 [0.640, 0.754] | 0.755 [0.658, 0.767] | 0.680 [0.618, 0.750] | -0.026 [-0.071, 0.018] | 0.013 [-0.025, 0.058] |
| 100 | 0.721 [0.669, 0.744] | 0.768 [0.738, 0.800] | 0.749 [0.669, 0.782] | -0.034 [-0.111, -0.010] | -0.030 [-0.088, 0.004] |
...
| labelled prompts | eval n | base acc | B0 | B0+rmd | B0+probe | B0+token probe | excess B0+rmd | excess B0+probe |
|---:|---:|---|---|---|---|---|---|---|
| 25 | 314 | 0.796 | 0.162 [0.135, 0.208] | 0.137 [0.086, 0.196] | 0.170 [0.146, 0.200] | 0.161 [0.140, 0.236] | -0.064 [-0.100, -0.005] | -0.028 [-0.052, -0.005] |
| 50 | 314 | 0.796 | 0.155 [0.128, 0.188] | 0.110 [0.082, 0.157] | 0.140 [0.079, 0.173] | 0.163 [0.095, 0.241] | -0.089 [-0.118, -0.043] | -0.059 [-0.115, -0.034] |
| 100 | 314 | 0.796 | 0.158 [0.127, 0.167] | 0.125 [0.076, 0.148] | 0.099 [0.069, 0.114] | 0.104 [0.069, 0.177] | -0.082 [-0.102, -0.050] | -0.102 [-0.119, -0.097] |
...
| labelled prompts | `rmd_tail_q20` | `probe_hidden_tail_q20` | `probe_token_tail_q20` | rmd − probe | rmd − token probe |
|---:|---|---|---|---|---|
| 25 | 0.645 [0.538, 0.708] | 0.654 [0.583, 0.680] | 0.618 [0.562, 0.728] | 0.011 [-0.092, 0.061] | 0.009 [-0.057, 0.051] |
| 50 | 0.676 [0.611, 0.736] | 0.695 [0.664, 0.747] | 0.695 [0.607, 0.755] | -0.014 [-0.074, 0.038] | -0.005 [-0.041, 0.029] |
| 100 | 0.719 [0.645, 0.748] | 0.743 [0.708, 0.760] | 0.727 [0.652, 0.785] | -0.012 [-0.119, 0.016] | -0.020 [-0.085, 0.036] |
...
| labelled prompts | eval n | base acc | B0 | B0+rmd | B0+probe | B0+token probe | excess B0+rmd | excess B0+probe |
|---:|---:|---|---|---|---|---|---|---|
| 25 | 328 | 0.671 | 0.242 [0.216, 0.327] | 0.255 [0.190, 0.320] | 0.238 [0.204, 0.324] | 0.236 [0.220, 0.344] | -0.079 [-0.121, -0.001] | -0.075 [-0.112, -0.003] |
| 50 | 328 | 0.671 | 0.238 [0.223, 0.283] | 0.184 [0.158, 0.221] | 0.210 [0.176, 0.234] | 0.212 [0.184, 0.342] | -0.127 [-0.160, -0.109] | -0.112 [-0.152, -0.081] |
| 100 | 328 | 0.671 | 0.229 [0.216, 0.265] | 0.168 [0.151, 0.202] | 0.166 [0.145, 0.201] | 0.170 [0.145, 0.213] | -0.154 [-0.164, -0.127] | -0.162 [-0.166, -0.119] |
